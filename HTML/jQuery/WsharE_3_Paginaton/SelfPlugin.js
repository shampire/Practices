            ...
            if(!getUrlCallback) {
		    	...
		    	else
			    {
    				lnk = $("<a>" + appendopts.text + "</a>")
	    				.attr('href', this.opts.link_to);
		    	}
			    if(appendopts.classes){ lnk.addClass(appendopts.classes); }
    			lnk.data('page_id', page_id);
	    		return lnk;
            } else {
                return opts.getUrlCallback();
...
debugger;
            ...
            if(!goToPageCallback) {
    			var continuePropagation = opts.goToPageCallback(current_page, containers);
        ...
        if(!goToPageCallback)
    		...
    		opts.goToPageCallback(current_page, containers);
    }
